...
namespace Assets._Project.Develop.Runtime.Gameplay.Features.PowerupVisual
{
    public class PowerupView : EntityView
    {
        ...
        [SerializeField] private GameObject _towerDamageEffectPrefab;
        ...
        private void PlayTowerDamageEffect()
        {
            if (_towerDamageEffectPrefab == null)
                return;

            GameplayVfxUtility.SpawnTransientAt(
                _towerDamageEffectPrefab,
                transform.position,
                Quaternion.identity,
                transform);
        }
