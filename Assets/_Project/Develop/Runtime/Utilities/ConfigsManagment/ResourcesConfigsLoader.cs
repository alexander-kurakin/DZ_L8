...
namespace Assets._Project.Develop.Runtime.Utilities.ConfigsManagment
{
    public class ResourcesConfigsLoader : IConfigsLoader
    {
        ...
        private readonly Dictionary<Type, string> _configsResourcesPaths = new()
        {
            ...
            {typeof(SpellcoreCombatConfig), "Configs/Gameplay/Spellcore/SpellcoreCombatConfig" },
            {typeof(TowerIntegrityConfig), "Configs/Gameplay/Spellcore/TowerIntegrityConfig" },
            ...
            {typeof(BuildingBuffCastAbilityConfig), "Configs/Gameplay/Entities/Abilities/BuildingBuffCastAbilityConfig" },
