...
namespace Assets._Project.Develop.Runtime.Configs.Gameplay.Entities
{
    ...
    public class ExplodingWalkingEnemyConfig : EntityConfig
    {
        ...
        [field: SerializeField] public bool StopAtInnerBeltAnchor { get; private set; }
        ...
        public float GetStopDistance(SectorGridConfig sectorGridConfig)
        {
            if (StopAtInnerBeltAnchor && sectorGridConfig != null)
                return sectorGridConfig.InnerBeltAnchorRadius;

            return DistanceToTargetGoal;
        }
    }
}