...
namespace Assets._Project.Develop.Runtime.Configs.Gameplay.Entities
{
    ...
    public class RangedShootingEnemyConfig : EntityConfig
    {
        ...
        [field: SerializeField] public bool StopAtMiddleBeltAnchor { get; private set; }
        ...
        {
            if (StopAtMiddleBeltAnchor && sectorGridConfig != null)
                return sectorGridConfig.MiddleBeltAnchorRadius;
