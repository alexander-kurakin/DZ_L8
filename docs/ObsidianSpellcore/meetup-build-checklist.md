...
**Статус:** playtest-ready · **волны freeze** (Intro1–5 / survival numbers не тюнить) · следующий шаг = **smoke + meetup**, не баланс.
...
Цель: подтвердить gate merge (§7 в [[plan-v3]]), **не** править pacing. Если что-то «не fun» — запиши note, не меняй `.asset` волн перед митапом.
